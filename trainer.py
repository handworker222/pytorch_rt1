...
class Trainer:
    def __init__(self, args):
        ...
        if utils.is_main_process():
            wandb.init(project="RT1-test", config=self.args)
    ...
    def train(self):
        ...
        # tensor = (torch.rand(4, 6, 3, 360, 640), torch.rand(4,6,512))
    ...
    def val(self, network_without_ddp, epoch, val_dataset, sampler_val=None):
        ...
        for idx, (obs, action) in tqdm(
            ...
            if utils.is_main_process():
                ...
                wandb.log(
                    data={
                        "val_loss_ce": val_loss,
                        "val_loss_mae": val_loss_mae.data.numpy(),
                        "val_epoch": epoch,
